      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="col-md-12">
            ...
            <a class="navbar-brand" href="#"><img src="img/logo.png" class="img-responsive" style={Buc1}/></a>
            </div>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-12">
          <div class="section-title">
            ...
            <a href="" style={Buc3}>Know more..</a>
          </div>
        </div>
        <div class="col-md-9 col-sm-8 col-xs-12">
          <div style={Buc4} class="col-sm-9 more-features-box">
